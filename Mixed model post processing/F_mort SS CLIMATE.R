...
#############
quartz(file=paste(base.dir,"/Salmon-Climate/Output plots/F_mortality heatmap ",NAME,".pdf",sep=""),height = 8.5, width=11,type="pdf",dpi=300)
  ...
  plot.heatmap( temp=t(as.matrix(F_troll_array + F_rec_array + F_treaty_array)),"Estimated Total Mortality",MONTH.STRUCTURE)
dev.off()
...
quartz(file=paste0(base.dir,"/Salmon-Climate/Output Plots/F Log-q time-series", NAME,".pdf"),dpi=300, width = 8,height=6, type="pdf")
