...
THESE <- seq(1,length(samp$sigma_pos_int),length.out=1000)
...
quartz(file=paste(base.dir,"/Salmon-Climate/Output plots/Juv Surv 2-year PUB min=3",NAME,".pdf",sep=""),height = 8, width=6,dpi=300,type="pdf")
