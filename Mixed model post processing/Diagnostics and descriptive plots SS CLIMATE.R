...
markdown.dir <- "/Users/ole.shelton/GitHub/Salmon-Climate/Writing/Markdown"
  
setwd(results.dir)
# load("FRAM_v1 AAA Mfix PHI-FIX CLIMATE, M proc error-FOUR LOGIT-vuln Troll_Rec_Treaty_Trawl_SS+PROC_M2FIX_SMOOTH_effort-SLOPE-Q_11-28-2019-24mon-EXTRA F(0.2).RData")
...
source("multiplot.r")
source("theme_acs.r")
source("Pairs SS CLIMATE.r")
#source("Obs-Pred SS + PROC.r")          # Script for making observed vs. predicted plots
source("Obs-Pred SS CLIMATE.r")          # Script for making observed vs. predicted plots
source("Log-likelihood tables.R")        # Script for calculating likelihood components
source("Spatial location SS CLIMATE.r")  # Script for making proportions in each area.
source("Spatial location plots SS Climate.r")
source("Spatial location Future Projections SS Climate.r")
source("Mat, Vuln plot SS CLIMATE.r") 
