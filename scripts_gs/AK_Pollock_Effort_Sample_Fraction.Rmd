...
\n Data from 2006-2020 the column "observers_onboard" indicates how many observers were onboard, we use htis to assign a trip to observed or unobserved effort. 


\n call w jordan 5/20 re early and late data: 
e-reporting started in 2003
...
```{r plot seperately by seasons SPRING}
...
\n Not many catcher processors in GOA
...
```{r data comparison to see how we can use 2003-2006 data}
