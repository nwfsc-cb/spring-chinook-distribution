...
knitr::include_graphics("./Figs-23-07/Offshore Dist V1-pois;TROLL_2_param,hake!=pollock,WAPEN=EAPEN,cv=hake,pollock,vuln=hake,pollock;4-season(single offshore,wint=avg),year+fing,ZEROS.pdf")
```
...
knitr::include_graphics("./Figs-23-07/Spatial Average Distribution plot SPRING V1-pois;TROLL_2_param,hake!=pollock,WAPEN=EAPEN,cv=hake,pollock,vuln=hake,pollock;4-season(single offshore,wint=avg),year+fing,ZEROS.jpeg")
```
...
knitr::include_graphics("./Figs-23-07/Spatial Average Distribution plot SUMMER V1-pois;TROLL_2_param,hake!=pollock,WAPEN=EAPEN,cv=hake,pollock,vuln=hake,pollock;4-season(single offshore,wint=avg),year+fing,ZEROS.jpeg")
```
...
knitr::include_graphics("./Figs-23-07/Spatial Average Distribution plot FALL V1-pois;TROLL_2_param,hake!=pollock,WAPEN=EAPEN,cv=hake,pollock,vuln=hake,pollock;4-season(single offshore,wint=avg),year+fing,ZEROS.jpeg")
```
