...
//////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // epsilon Matt trick
    ...
    // Add season offsets to the log_q values for troll and rec fisheries.
      
        for(i in 1:N_loc){
            log_q_troll_pos[,i] = log_q_troll_pos[,i] + 
            ...
            log_q_rec_pos[,i] = log_q_troll_pos[,i] + 
